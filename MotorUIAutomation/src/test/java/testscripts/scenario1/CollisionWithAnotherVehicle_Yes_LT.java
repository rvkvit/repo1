 ...
 * @author LT
 */
public class CollisionWithAnotherVehicle_Yes_LT extends TestCase
{
	@Test
	@Parameters("browser")
	public void runTC1(String browser) throws InvalidFormatException
	{
		testParameters.setCurrentTestDescription("Test MFNOL (LT) - Cause : Collision(with another vehicle); User : PH");
