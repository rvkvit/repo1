...
public class ExcelReport implements ReportType {
	...
	public ExcelReport(ReportSettings reportSettings, ReportTheme reportTheme) {
		...
		this.testLogAccess = new ExcelDataAccess(
				reportSettings.getReportPath() + Util.getFileSeparator() + "Excel Results",
	...
	private void initializeTestLogColorPalette() {
		this.testLogAccess.setCustomPaletteColor(8, this.reportTheme.getHeadingBackColor());
		this.testLogAccess.setCustomPaletteColor(9, this.reportTheme.getHeadingForeColor());
		this.testLogAccess.setCustomPaletteColor(10, this.reportTheme.getSectionBackColor());
		this.testLogAccess.setCustomPaletteColor(11, this.reportTheme.getSectionForeColor());
		this.testLogAccess.setCustomPaletteColor(12, this.reportTheme.getContentBackColor());
		this.testLogAccess.setCustomPaletteColor(13, this.reportTheme.getContentForeColor());
		...
		if (stepContainsScreenshot)
			if (this.reportSettings.linkScreenshotsToTestLog) {
				...
				this.testLogAccess.setValue(rowNum, "Description",
						stepDescription + " (Refer screenshot @ " + screenShotName + ")", this.cellFormatting);
			}
		else
			this.testLogAccess.setValue(rowNum, "Description", stepDescription, this.cellFormatting);
	}
	...
	private boolean processStatusColumn(Status stepStatus) {
		...
		case 4:
			this.cellFormatting.setForeColorIndex(17);
			stepContainsScreenshot = false; // here ordinal is for Done, so we don't need to take screenshots 
			break;
		case 6:
	...
	private void wrapUpTestLog() {
		...
		//this.testLogAccess.addOuterBorder(0, 4); LT changes
	...
	private void initializeResultSummaryColorPalette() {
		this.resultSummaryAccess.setCustomPaletteColor(8, this.reportTheme.getHeadingBackColor());
		this.resultSummaryAccess.setCustomPaletteColor(9, this.reportTheme.getHeadingForeColor());
		this.resultSummaryAccess.setCustomPaletteColor(10, this.reportTheme.getSectionBackColor());
		this.resultSummaryAccess.setCustomPaletteColor(11, this.reportTheme.getSectionForeColor());
		this.resultSummaryAccess.setCustomPaletteColor(12, this.reportTheme.getContentBackColor());
		this.resultSummaryAccess.setCustomPaletteColor(13, this.reportTheme.getContentForeColor());
	...
	//	this.resultSummaryAccess.addOuterBorder(0, 4); LT changes
