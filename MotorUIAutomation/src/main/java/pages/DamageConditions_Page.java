...
public class DamageConditions_Page extends  MasterPage{
	
	CommonFunctions CF = new CommonFunctions(scriptHelper);
	public DamageConditions_Page(ScriptHelper scriptHelper)
	{
		super(scriptHelper);	
	}
	...
	public DamageConditions_Page DamageConditionYes() throws InterruptedException {
		...
		return new DamageConditions_Page(scriptHelper);
	}
