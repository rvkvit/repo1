...
public class OtherVehicleDamages_Page extends MasterPage{
	
	CommonFunctions CF = new CommonFunctions(scriptHelper);
	public OtherVehicleDamages_Page(ScriptHelper scriptHelper)
	...
	public OtherVehicleDamages_Page OtherVehicleDamagedYes() throws InterruptedException{
		...
		return new OtherVehicleDamages_Page(scriptHelper);
	}
}
